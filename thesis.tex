...
folyamatos működést biztosító szoftverek fejlesztésére fejlesztették, az Erlang 
...
adatokat. Az üzemltető -- tegyük fel -- kis cégnek lehetősgée van arra, hogy az
üzlet sikerével párhuzamosan növelje a szerver-klaszter kapacitását: egyszerűen
csak el kell indítani egy újab node-ot, és azzal ,,megpingetni'' az egyik
...
felparaméterezve elküldeni a node-re, majd begyűjteni az eredményt
(a \texttt{spawn} a hálózat tetszőleges node-on működik). Ezzel a
