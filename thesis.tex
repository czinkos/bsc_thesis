...
A fenti start függvény elindít egy másik process-t, és összekapcsolja a
...
egy process-t futtat, amíg egy \texttt{stop} atomot nem kap üzenetként. A
...
A puding próbája az evés -- az Erlang shellben. A \texttt{self()} függvény az
...
processek hierarchiába rendezhetők, ennek megfelelően van háromféle típusú
process.
...
felügyelete, folyamatosan monitorozza azok állapotát, hiba esetén észleli, hogy
