...
indítani helyben vagy akár egy másik node-on. A process-ek egyedi azonosítót
kapnak, amely a címük, ide lehet küldeni az üzenetet. Van lehetőség arra is,
hogy a process nevet kapjon, ezt hosszabb ideig futó processeknél érdemes
megtenni.

\subparagraph{Üzenet küldése} Üzenetet küldeni a következők szerint lehet:
\begin{verbatim}
          P ! "Hello" 
\end{verbatim} ahol \texttt{P} a process azonosítója vagy regisztrált
...
fogadására. A függvényekhez hasonlóan \emph{clause}-okat tartalmaz, és itt is
