...
{\lstset{basicstyle=\footnotesize, showstringspaces=false, emphstyle=\textbf, caption= #2,language= #1, frame=single}}
{}
...
Ehhez hasonlóan a számítógépes aktorok (Erlangban: \emph{process}) is képesek:
\begin{itemize}
...
gépen lévő process-el akar kommunikálni. A szintaxis ugyanaz helyben mint gépek
között.

Az Erlang tehát egy aszinkron üzenetküldésre épülő platform, ahol minden aktor
birtokában van a működéséhez szükséges összes inormációnak,  
